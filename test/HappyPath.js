var Craigslist = artifacts.require('./contracts/LamboExchange.sol');
...
contract('LamboExchange', function(accounts) {
    ...
    it(" ---> token count should be 0 when contract is deployed", function() {
        return LamboExchange.deployed().then(function(instance) {
            contractInstance = instance;
            return contractInstance.tokensCount.call();
        }).then(function(data) {
            assert.equal(data, 0, 'tokensCount should be 0');
        });
    });
/*
